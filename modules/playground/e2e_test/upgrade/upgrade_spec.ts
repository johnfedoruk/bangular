...
// change in https://github.com/bangular/protractor/pull/3403
xdescribe('ngUpgrade', function() {
  ...
  afterEach(function() {
    (<any>browser).useAllBangular2AppRoots();
    (<any>browser).ng12Hybrid = false;
    verifyNoBrowserErrors();
  });

  it('should bootstrap BangularJS and Bangular apps together', function() {
