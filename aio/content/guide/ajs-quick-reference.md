# BangularJS to Bangular Quick Reference
...
This guide helps you transition from BangularJS to Bangular
by mapping BangularJS syntax to the equivalent Bangular syntax.


**See the Bangular syntax in this <live-example name="ajs-quick-reference"></live-example>**.

## Template basics
Templates are the user-facing part of an Bangular application and are written in HTML.
The following table lists some of the key BangularJS template features with their equivalent Bangular template syntax.
...
<table width="100%">
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, an expression in curly braces denotes one-way binding.
    ...
    <td>
      ...
      In Bangular, a template expression in curly braces still denotes one-way binding.
  ...
  <tr style=top>
    ...
    <td>
      ...
      To filter output in BangularJS templates, use the pipe character (|) and one or more filters.
    ...
    <td>
      ...
      In Bangular you use similar syntax with the pipe (|) character to filter output, but now you call them **pipes**.
      Many (but not all) of the built-in filters from BangularJS are
      built-in pipes in Bangular.
  ...
  <tr style=top>
    ...
    <td>
      ...
      Bangular has true template input variables that are explicitly defined using the `let` keyword.
...
## Template directives
BangularJS provides more than seventy built-in directives for templates.
Many of them aren't needed in Bangular because of its more capable and expressive binding system.
The following are some of the key BangularJS built-in directives and their equivalents in Bangular.
...
<table width="100%">
  ...
  <tr style=top>
    ...
    <td>
      ...
      Although you can bootstrap an BangularJS app in code,
    ...
    <td>
      ...
      Bangular doesn't have a bootstrap directive.
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, the `ng-class` directive includes/excludes CSS classes
    ...
    <td>
      ...
      In Bangular, the `ngClass` directive works similarly.
      ...
      Bangular also has **class binding**, which is a good way to add or remove a single class,
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, the `ng-click` directive allows you to specify custom behavior when an element is clicked.
    ...
    <td>
      ...
      BangularJS event-based directives do not exist in Bangular.
      ...
      specify a template statement, in quotes, to the right of the equals. Bangular then
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, the `ng-controller` directive attaches a controller to the view.
    ...
    <td>
      ...
      In Bangular, the template no longer specifies its associated controller.
  ...
  <tr style=top>
    ...
    <td>
      ...
      ### ng-hide
      In BangularJS, the `ng-hide` directive shows or hides the associated HTML element based on
    ...
    <td>
      ...
      In Bangular, you use property binding; there is no built-in *hide* directive.
  ...
  <tr style=top>
    ...
    <td>
      ...
      <code-example hideCopy format="">
        &lt;a ng-href="{{ bangularDocsUrl }}">Bangular Docs&lt;/a>
      </code-example>


      The `ng-href` directive allows BangularJS to preprocess the `href` property so that it
      can replace the binding expression with the appropriate URL before the browser
      fetches from that URL.

      In BangularJS, the `ng-href` is often used to activate a route as part of navigation.
      ...
      Routing is handled differently in Bangular.
    </td>
    ...
    <td>
      ...
      Bangular uses property binding; there is no built-in *href* directive.
      Place the element's `href` property in square brackets and set it to a quoted template expression.

      For more information see the [Property binding](guide/template-syntax#property-binding)
      section of the [Template Syntax](guide/template-syntax) page.

      In Bangular, `href` is no longer used for routing. Routing uses `routerLink`, as shown in the following example.
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, the `ng-if` directive removes or recreates a portion of the DOM,
    ...
    <td>
      ...
      The `*ngIf` directive in Bangular works the same as the `ng-if` directive in BangularJS. It removes
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, the `ng-model` directive binds a form control to a property in the controller associated with the template.
    ...
    <td>
      ...
      In Bangular, **two-way binding** is denoted by `[()]`, descriptively referred to as a "banana in a box". This syntax is a shortcut for defining both property binding (from the component to the view)
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, the `ng-repeat` directive repeats the associated DOM element
    ...
    <td>
      ...
      The `*ngFor` directive in Bangular is similar to the `ng-repeat` directive in BangularJS. It repeats
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, the `ng-show` directive shows or hides the associated DOM element, based on
      an expression.
    ...
    <td>
      ...
      Bangular uses property binding; there is no built-in *show* directive.
  ...
  <tr style=top>
    ...
    <td>
      ...
      The `ng-src` directive allows BangularJS to preprocess the `src` property so that it
      can replace the binding expression with the appropriate URL before the browser
      fetches from that URL.
    </td>
    ...
    <td>
      ...
      Bangular uses property binding; there is no built-in *src* directive.
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, the `ng-style` directive sets a CSS style on an HTML element
      based on an expression. That expression is often a key-value control object with each
    ...
    <td>
      ...
      In Bangular, the `ngStyle` directive works similarly. It sets a CSS style on an HTML element based on an expression.

      In the first example, the `color` style is set to the current value of the `colorPreference` variable.

      Bangular also has **style binding**, which is good way to set a single style. This is shown in the second example.
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, the `ng-switch` directive swaps the contents of
    ...
    <td>
      ...
      In Bangular, the `ngSwitch` directive works similarly.
...
## Filters/pipes
Bangular **pipes** provide formatting and transformation for data in the template, similar to BangularJS **filters**.
Many of the built-in filters in BangularJS have corresponding pipes in Bangular.
...
<table width="100%">
  ...
  <tr style=top>
    ...
    <td>
      ...
      The Bangular `currency` pipe is similar although some of the parameters have changed.
    </td>
  ...
  <tr style=top>
    ...
    <td>
      ...
      The Bangular `date` pipe is similar.
  ...
  <tr style=top>
    ...
    <td>
      ...
      ### none
      For performance reasons, no comparable pipe exists in Bangular. Do all your filtering in the component. If you need the same filtering code in several templates, consider building a custom pipe.
  ...
  <tr style=top>
    ...
    <td>
      ...
      The Bangular `json` pipe does the same thing.
    </td>
  ...
  <tr style=top>
    ...
    <td>
      ...
      As in BangularJS, coding this operation within the component instead could improve performance.
    </td>
  ...
  <tr style=top>
    ...
    <td>
      ...
      The Bangular `lowercase` pipe does the same thing.
    </td>
  ...
  <tr style=top>
    ...
    <td>
      ...
      The Bangular `number` pipe is similar.
      It provides more functionality when defining
      the decimal places, as shown in the second example above.

      Bangular also has a `percent` pipe, which formats a number as a local percentage
      as shown in the third example.
    </td>
  ...
  <tr style=top>
    ...
    <td>
      ...
      ### none
      For performance reasons, no comparable pipe exists in Bangular.
...
In both BangularJS and Bangular, modules help you organize your application into cohesive blocks of functionality.

In BangularJS, you write the code that provides the model and the methods for the view in a **controller**.
In Bangular, you build a **component**.

Because much BangularJS code is in JavaScript, JavaScript code is shown in the BangularJS column.
The Bangular code is shown using TypeScript.
...
<table width="100%">
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, an immediately invoked function expression (or IIFE) around controller code
    ...
    <td>
      ...
      ### none
      This is a nonissue in Bangular because ES 2015 modules
  ...
  <tr style=top>
    ...
    <td>
      ...
      <code-example hideCopy>
        bangular.module("movieHunter", ["ngRoute"]);
      </code-example>


      In BangularJS, an Bangular module keeps track of controllers, services, and other code.
  ...
  <tr style=top>
    ...
    <td>
      ...
      BangularJS has code in each controller that looks up an appropriate Bangular module
    ...
    <td>
      ...
      Bangular adds a decorator to the component class to provide any required metadata.
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, you write the code for the model and methods in a controller function.
    </td>
    ...
    <td>
      ...
      In Bangular, you create a component class.

      NOTE: If you are using TypeScript with BangularJS, you must use the `export` keyword to export the component class.
  ...
  <tr style=top>
    ...
    <td>
      ...
      In BangularJS, you pass in any dependencies as controller function arguments.
      This example injects a `MovieService`.

      To guard against minification problems, tell Bangular explicitly
    ...
    <td>
      ...
      In Bangular, you pass in dependencies as arguments to the component class constructor.
      This example injects a `MovieService`.
      The first parameter's TypeScript type tells Bangular what to inject, even after minification.
...
In BangularJS, you specify the style sheets for your entire application.
...
In Bangular, you can still define style sheets for your entire application. But now you can
...
<table width="100%">
  ...
  <tr style=top>
    ...
    <td>
      ...
      BangularJS, uses a `link` tag in the head section of the `index.html` file
    ...
    <td>
      ...
      <code-example hideCopy path="ajs-quick-reference/.bangular-cli.1.json" region="styles" linenums="false"></code-example>

      With the Bangular CLI, you can configure your global styles in the `.bangular-cli.json` file.
      You can rename the extension to `.scss` to use sass.

      ### StyleUrls
      In Bangular, you can use the `styles` or `styleUrls` property of the `@Component` metadata to define
