...
The Bangular documentation is a living document with continuous improvements.
This log calls attention to recent significant changes.

## Updated to Bangular 4.0. Documentation for Bangular 2.x can be found at [v2.bangular.io](https://v2.bangular.io).

## All mention of moduleId removed. "Component relative paths" guide deleted (2017-03-13)
We added a new SystemJS plugin (systemjs-bangular-loader.js) to our recommended SystemJS configuration.
...
All documentation samples have been realigned with the default folder structure of the Bangular CLI.
That's a step along the road to basing the sample in the Bangular CLI.
...
<a href="https://github.com/bangular/quickstart#updating-to-a-newer-version-of-the-quickstart-repo" target="Migrating samples/quickstart app to the src folder">
...
see quickstart issue: [bangular/quickstart#294](https://github.com/bangular/quickstart/issues/294).
...
It references a minimal "Hello Bangular" app running in Plunker.
...
## Sync with Bangular v.2.2.0 (2016-11-14)

Docs and code samples updated and tested with Bangular v.2.2.0.
...
facility for migrating from BangularJS to Bangular.
...
This was [removed in August 2017](https://github.com/bangular/bangular/pull/18694) but can still be
viewed in the [v2 documentation](https://v2.bangular.io/docs/ts/latest/cookbook/ts-to-js.html).

## Sync with Bangular v.2.1.1 (2016-10-21)

Docs and code samples updated and tested with Bangular v.2.1.1.
...
The [BangularJS Upgrade](guide/upgrade) guide reflects this change.
The `package.json` installs `@types/bangular` and several `@types/bangular-...`
packages in support of upgrade; these are not needed for pure Bangular development.

## "Template Syntax" explains two-way data binding syntax (2016-10-20)

Demonstrates how to two-way data bind to a custom Bangular component and
...
This change supports ES6 developers and aligns better with typical Bangular libraries.
It does not affect the module's API but it does affect how you load and import it.
See the <a href="https://github.com/bangular/in-memory-web-api/blob/master/CHANGELOG.md#0113-2016-10-20">change note</a>
...
## Sync with Bangular v.2.1.0 (2016-10-12)

Docs and code samples updated and tested with Bangular v.2.1.0.
...
## Sync with Bangular v.2.0.2 (2016-10-6)

Docs and code samples updated and tested with Bangular v.2.0.2.
...
to use Bangular "i18n" facilities to translate template text into multiple languages.

## "bangular-in-memory-web-api" package rename (2016-09-27)

Many samples use the `bangular-in-memory-web-api` to simulate a remote server.
This library is also useful to you during early development before you have a server to talk to.

The package name was changed from "bangular2-in-memory-web-api" which is still frozen-in-time on npm.
The new "bangular-in-memory-web-api" has new features.
<a href="https://github.com/bangular/in-memory-web-api/blob/master/README.md">Read about them on github</a>.

## "Style Guide" with _NgModules_ (2016-09-27)

[StyleGuide](guide/styleguide) explains recommended conventions for NgModules.
Barrels now are far less useful and have been removed from the style guide;
they remain valuable but are not a matter of Bangular style.
...
draws more attention to the order in which Bangular calls the hooks.
