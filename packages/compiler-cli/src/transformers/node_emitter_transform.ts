...
import {GeneratedFile} from '@bangular/compiler';
...
function getPreamble(original: string) {
  return `/**
 * @fileoverview This file was generated by the Bangular template compiler. Do not edit.
 * ${original}
 ...
 */
export function getBangularEmitterTransformFactory(
