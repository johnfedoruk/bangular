  ...
  describe('compile ngfactory files', () => {
    ...
    it('should compile ngfactory files that are not referenced by root files', () => {
      ...
      expect(fs.existsSync(path.resolve(
                 outDir, 'node_modules', '@bangular', 'core', 'src',
    ...
    describe('comments', () => {
      function compileAndRead(contents: string) {
        writeConfig(`{
          "extends": "./tsconfig-base.json",
          "files": ["mymodule.ts"],
          "bangularCompilerOptions": {"allowEmptyCodegenFiles": true}
        }`);
      ...
      `);
        ...
        expect(contents).toContain('generated by the Bangular template compiler');
      ...
      it('should be included in empty files', () => {
        ...
        @Injectable()
        export class NotAnBangularComponent {}
      `);
    ...
    describe(`emit generated files depending on the source file`, () => {
      ...
      beforeEach(() => {
        write('src/comp.ts', `
              import {Component, ViewEncapsulation} from '@bangular/core';
    ...
    describe('closure', () => {
      ...
      it('should add metadata as static fields', () => {
        ...
        // as regression test for https://github.com/bangular/bangular/issues/19916.
        writeConfig(`{
          "extends": "./tsconfig-base.json",
          "compilerOptions": {
    ...
    describe('expression lowering', () => {
      ...
      it('should be able to lower supported expressions', () => {
        ...
        write('module.ts', `
          import {NgModule, InjectionToken} from '@bangular/core';
    ...
    it('should be able to compile multiple libraries with summaries', () => {
      ...
      write('tsconfig-ng.json', `{
          ...
          "include": ["node_modules/@bangular/core/**/*"],
          "exclude": [
            "node_modules/@bangular/core/test/**",
            "node_modules/@bangular/core/testing/**"
          ]
        }`);
      ...
      write('app/main.ts', `
          import {NgModule, Inject} from '@bangular/core';
    ...
    it('should be able to compile libraries with summaries and flat modules', () => {
      ...
      function writeFiles() {
        ...
        write('tsconfig-lib.json', `{
          ...
          "include": ["node_modules/@bangular/core/**/*", "node_modules/flat_module/**/*"],
          "exclude": [
            "node_modules/@bangular/core/test/**",
            "node_modules/@bangular/core/testing/**"
          ]
  ...
  describe('regressions', () => {
    ...
    it('should recognize @NgModule() directive with a redundant @Injectable()', () => {
      ...
      write('src/test-module.ts', `
        import {Injectable, NgModule} from '@bangular/core';
    ...
    it('should not stack overflow on a recursive module import', () => {
      ...
      write('src/test-module.ts', `
        import {Component, NgModule, forwardRef} from '@bangular/core';
...
`);
  ...
  describe('ivy', () => {
    ...
    it('should emit an injection of a string token', () => {
      ...
      write('hello-world.ts', `
        import {Component, Inject, NgModule} from '@bangular/core';
