...
See [here for an example project](https://github.com/bangular/benchpress-tree).
...
* Use normalized environments
  ...
  - e.g. a real mobile device whose cpu frequency is set to a fixed value.
      * see our [build script](https://github.com/bangular/bangular/blob/2.4.9/scripts/ci/android_cpu.sh)
