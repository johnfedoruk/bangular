...
import {isPlatformServer} from '@bangular/common';
import {Component, Inject, PLATFORM_ID} from '@bangular/core';
import {StateKey, TransferState, makeStateKey} from '@bangular/platform-browser';
