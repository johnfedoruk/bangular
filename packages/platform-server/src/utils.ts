...
import {ApplicationRef, NgModuleFactory, NgModuleRef, PlatformRef, StaticProvider, Type} from '@bangular/core';
import {ɵTRANSITION_ID} from '@bangular/platform-browser';
